...
<html>
	...
	<body>			
		...
		$sqlsaishi="select * from saishi where conter='足球热门赛事' order by 
		 rand() limit 3";
...
if($page>=2){
	$a=$page-1;
	echo "<a href='ty-liansaizhq.php?page=1'>首页</a>";
    echo "<a href='ty-liansaizhq.php?page=$a'>上一页</a>";
}
?>
...
if($page<$pageTotal){
	$c=$pageTotal;
	$b=$page+1;
	echo "<a href='ty-liansaizhq.php?page=$c'>尾页</a>";
    echo "<a href='ty-liansaizhq.php?page=$b'>下一页</a>";
}
?>	
				...
				<?php
			include '../public/common/config.php';
			$sqlsai="select * from saishi where conter='足球美洲赛事'";
		 $rstsai=mysqli_query($link,$sqlsai);
	   while($rowsai=mysqli_fetch_array($rstsai)){
		?>
		<li><img src="../admin/public/uploads/<?php echo $rowsai['img']?>" />
		...
		?>
				...
				<?php
			include '../public/common/config.php';
			$sqlsai="select * from saishi where conter='足球欧洲赛事'";
		 $rstsai=mysqli_query($link,$sqlsai);
	   while($rowsai=mysqli_fetch_array($rstsai)){
		?>
		<li><img src="../admin/public/uploads/<?php echo $rowsai['img']?>" />
		...
		?>
				...
				<?php
			include '../public/common/config.php';
			$sqlsai="select * from saishi where conter='足球亚洲赛事'";
		 $rstsai=mysqli_query($link,$sqlsai);
	   while($rowsai=mysqli_fetch_array($rstsai)){
		?>
		<li><img src="../admin/public/uploads/<?php echo $rowsai['img']?>" />
		...
		?>
				...
				<?php
			include '../public/common/config.php';
			$sqlsai="select * from saishi where conter='足球洲际赛事'";
		 $rstsai=mysqli_query($link,$sqlsai);
	   while($rowsai=mysqli_fetch_array($rstsai)){
		?>
		<li><img src="../admin/public/uploads/<?php echo $rowsai['img']?>" />
